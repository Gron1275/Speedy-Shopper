...
class MainFrame(wx.Frame):
    ...
    def __init__(self):
        ...
        self.help_button = wx.Button(self, wx.ID_ANY, u"Help", wx.Point(434, 0), wx.Size(50,25), 0)
        ...
        self.help_button.Bind(wx.EVT_BUTTON, self.helpwin(self, full_box, welcome_box, input_box))
    ...
    def helpwin(self, event, full_box, welcome_box, input_box):
        self.SetSizeHints(wx.DefaultSize, wx.DefaultSize)
        self.full_box.Hide()
        self.welcome_box.Hide()
        self.input_box.Hide()
        bSizer1 = wx.BoxSizer(wx.VERTICAL)

        self.m_staticText1 = wx.StaticText(self, wx.ID_ANY, u"asdasda", wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText1.Wrap(-1)
